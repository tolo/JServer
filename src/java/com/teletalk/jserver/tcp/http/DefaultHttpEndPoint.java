 ...
 * @since 2.1 (20050525)
 */
public class DefaultHttpEndPoint extends HttpEndPoint
{
   ...
   /**
    * Creates  a new DefaultHttpEndPoint.
    * 
    * @param commManager reference to a parent HttpCommunicationManager.
    */
   public DefaultHttpEndPoint(final HttpCommunicationManager commManager)
   {
      this(commManager, "DefaultHttpEndPoint");
   }
    ...
    * 
    * @param commManager reference to a parent HttpCommunicationManager.
    * @param name the name of this DefaultHttpEndPoint.
    */
   public DefaultHttpEndPoint(final HttpCommunicationManager commManager, final String name)
   {
   ...
   public void request(final HttpRequest req) throws java.io.IOException
   {
      ...
      else
      {
         ...
         else
         {
            ...
            if(reqPath.endsWith("/")) 
            {
               file = new File(reqPath + "/" + "index.html");
               sendFileResponse(file);
            }
            else
            {
               file = new File(reqPath);
               ...
               if( file.exists() )
               {
                  ...
                  else sendFileResponse(file);
               } //Attempt to get requested path as resource
               else sendResourceResponse(reqPath);
            }
         }
      }
   }
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createAliveResponse(this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createVersionResponse(longVersion, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createNameResponse(this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createDiskFreeSpaceResponse(req, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createRedirectResponse(path, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createOkResponse(body, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createOkResponse(body, contentType, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createResponse(responseCode, responseDescription, body, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createResponse(responseCode, responseDescription, body, contentType, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createFileNotFoundResponse(fileName, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createFileResponse(file, sendFileNotFound, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createResourceResponse(resourceName, sendFileNotFound, this);
   ...
   {
      HttpResponse rsp = HttpResponseUtils.createUrlResponse(url, this);
